...
class Transformer(nn.Module):
    ...
    def forward(self, src, mask, query_embed, pos_embed):
        ...
        # ...
        # DONE: Handled case of 3-dim vs 4-dim;
        shapes = src.shape 
        bs = shapes[0]
        ...
        if len(shapes) == 4:
            ...
            raise NotImplementedError(f"Input with {len(shapes)}-dim isn't supported yet (only 4-dim and 3-dim cases implemented).")
        ...
        return hs.transpose(1, 2), memory.permute(1, 2, 0).view(*shapes)
